...
# Headers:
HEADERS += ./include/SphereGen.h
HEADERS += ./include/SphereGenInterface.hh

# Sources:
SOURCES += ./src/SphereGen.cpp
...
# Forms:
FORMS += ./forms/SphereSettings.ui

# Resources
RESOURCES += spheregenerator_icon.qrc
