...
#include "TorusGenInterface.hh"
#include "./../../renderer/include/RendererTypes.h" //For Vertex
#include "./../ui_TorusSettings.h"
...
/*! \file
* 
*  \brief Describes the class TorusGen, their methodes and attributes.
*  \author Reinhard Jeschull
* 
*/


/*! \brief The torus generator
*
* This plugin class generates a torus and adds it to the scene
*/
class TorusGen : public TorusGenInterface
{
	Q_OBJECT
...
private:
	...
	*/	
	void createTorus(vector<int>& indices, vector<BSRenderer::Vertex>& verts,
...
private: 
	...
	Ui_TorusSettings m_ui; /*!< \brief The widget for the properties*/
