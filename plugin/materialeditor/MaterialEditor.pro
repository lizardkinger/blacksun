...
# Headers:
HEADERS += ./include/MatEdit.h
HEADERS += ./include/MatEditInterface.hh
HEADERS += ./include/MatEditColorChooser.h
HEADERS += ./include/MatEditPreview.h
HEADERS += ./include/MaterialEditor.h

# Sources:
SOURCES += ./src/MatEdit.cpp
SOURCES += ./src/MatEditColorChooser.cpp
SOURCES += ./src/MatEditPreview.cpp
SOURCES += ./src/MaterialEditor.cpp

# Forms:
FORMS += ./forms/MaterialEditor.ui
