...
/*! \file
* 
*  \brief Describes the class MatEdit, their methodes and attributes.
...
*
* This plugin class provides a tool to manage materials
*/
class MatEdit : public MatEditInterface
{
	Q_OBJECT
...
private: 
	...
	QAction* m_pActionMatEdit; 		/*!< \brief Action for the menu item*/	
	
	MaterialEditor* m_matEdit; /*!< \brief The material editor*/
