#
# Projectfile for the pyramidgenerator
#
# by Xexis
#

# Headers:
HEADERS += ./include/PyramidGen.h
HEADERS += ./include/PyramidGenInterface.hh

# Sources:
SOURCES += ./src/PyramidGen.cpp

#Forms:
FORMS +=./include/settings.ui

# Resources
RESOURCES += pyramidgenerator_icon.qrc
