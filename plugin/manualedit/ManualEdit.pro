...
# Headers:
HEADERS += ./include/ManualEdit.h
HEADERS += ./include/ManualEditInterface.hh
HEADERS += ./include/ManEdit.h

# Sources:
SOURCES += ./src/ManualEdit.cpp
SOURCES += ./src/ManEdit.cpp

# Forms:
FORMS += ./forms/ManualEditDialog.ui
