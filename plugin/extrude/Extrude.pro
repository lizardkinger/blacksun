#
# Projectfile for the Extrude-Plugin
#
# by Xexis
#

# Headers:
HEADERS += ./include/Extrude.h
HEADERS += ./include/ExtrudeInterface.hh

# Sources:
SOURCES += ./src/Extrude.cpp
...
# Forms:
FORMS += ./forms/ExtrudeSettings.ui 

# Resources
RESOURCES += extrude_icon.qrc
