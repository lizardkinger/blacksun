#
# Projectfile for the Revolving-Plugin
#
# by Xexis
#

# Headers:
HEADERS += ./include/Revolving.h
HEADERS += ./include/RevolvingInterface.hh

# Sources:
SOURCES += ./src/Revolving.cpp

#Forms:
FORMS +=./include/settings.ui

# Resources
RESOURCES += revolving_icon.qrc
