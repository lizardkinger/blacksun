 ...
 *  File:       TextureLoaderPluginJPEG.h
 *  Created:    20.02.2006
 *  Author:     Reinhard Jeschull (rjeschu)
 *
 **************************************************************************/

#ifndef TEXTURELOADERPLUGINJPEG_H_
#define TEXTURELOADERPLUGINJPEG_H_
...
/*! \file
* 
*  \brief Describes the class TextureLoaderPluginJPEG, their methodes and attributes.
*  \author Reinhard Jeschull
* 
*/


/*! \brief The TextureLoader for JPEG
*
* This plugin class provides a TextureLoader for Joint Photographic Experts Group (JPEG)
*/
class TextureLoaderPluginJPEG: public TextureLoaderPluginQImage
{
public:	
	/*!
...
#endif /*TEXTURELOADERPLUGINJPEG_H_*/
