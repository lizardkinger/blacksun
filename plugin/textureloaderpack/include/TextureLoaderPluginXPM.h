 ...
 *  File:       TextureLoaderPluginXPM.h
 *  Created:    20.02.2006
 *  Author:     Reinhard Jeschull (rjeschu)
 *
 **************************************************************************/

#ifndef TEXTURELOADERPLUGINXPM_H_
#define TEXTURELOADERPLUGINXPM_H_
...
/*! \file
* 
*  \brief Describes the class TextureLoaderPluginXPM, their methodes and attributes.
*  \author Reinhard Jeschull
* 
*/


/*! \brief The TextureLoader for XPM
*
* This plugin class provides a TextureLoader for X11 Pixmaps (XPM)
*/
class TextureLoaderPluginXPM: public TextureLoaderPluginQImage
{
public:
	/*!
...
#endif /*TEXTURELOADERPLUGINXPM_H_*/
