 ...
 *  File:       TextureLoaderPluginJPG.h
 *  Created:    20.02.2006
 *  Author:     Reinhard Jeschull (rjeschu)
 *
 **************************************************************************/

#ifndef TEXTURELOADERPLUGINJPG_H_
#define TEXTURELOADERPLUGINJPG_H_
...
/*! \file
* 
*  \brief Describes the class TextureLoaderPluginJPG, their methodes and attributes.
*  \author Reinhard Jeschull
* 
*/


/*! \brief The TextureLoader for JPG
*
* This plugin class provides a TextureLoader for Joint Photographic Experts Group (JPG)
*/
class TextureLoaderPluginJPG: public TextureLoaderPluginQImage
{
public:	
	/*!
...
#endif /*TEXTURELOADERPLUGINJPG_H_*/
