 ...
 *  File:       TextureLoaderPluginPGM.h
 *  Created:    20.02.2006
 *  Author:     Reinhard Jeschull (rjeschu)
 *
 **************************************************************************/

#ifndef TEXTURELOADERPLUGINPGM_H_
#define TEXTURELOADERPLUGINPGM_H_
...
/*! \file
* 
*  \brief Describes the class TextureLoaderPluginPGM, their methodes and attributes.
*  \author Reinhard Jeschull
* 
*/


/*! \brief The TextureLoader for PGM
*
* This plugin class provides a TextureLoader for Portable Graymap (PGM)
*/
class TextureLoaderPluginPGM: public TextureLoaderPluginQImage
{
public:	
	/*!
...
#endif /*TEXTURELOADERPLUGINPGM_H_*/
