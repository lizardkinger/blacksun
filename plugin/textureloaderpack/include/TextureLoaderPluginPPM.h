 ...
 *  File:       TextureLoaderPluginPPM.h
 *  Created:    20.02.2006
 *  Author:     Reinhard Jeschull (rjeschu)
 *
 **************************************************************************/

#ifndef TEXTURELOADERPLUGINPPM_H_
#define TEXTURELOADERPLUGINPPM_H_
...
/*! \file
* 
*  \brief Describes the class TextureLoaderPluginPPM, their methodes and attributes.
*  \author Reinhard Jeschull
* 
*/


/*! \brief The TextureLoader for PPM
*
* This plugin class provides a TextureLoader for Portable Pixmap (PPM)
*/
class TextureLoaderPluginPPM: public TextureLoaderPluginQImage
{
public:	
	/*!
...
#endif /*TEXTURELOADERPLUGINPPM_H_*/
