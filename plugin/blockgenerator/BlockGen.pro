#
# Projectfile for the Block-Generator
#
# by Xexis
#

# Headers:
HEADERS += ./include/BlockGen.h
HEADERS += ./include/BlockGenInterface.hh

# Sources:
SOURCES += ./src/BlockGen.cpp

#Forms:
FORMS +=./include/settings.ui

# Resources
RESOURCES += blockgenerator_icon.qrc
