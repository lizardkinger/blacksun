...
# Headers:
HEADERS += ./include/GeoSphereGen.h
HEADERS += ./include/GeoSphereGenInterface.hh

# Sources:
SOURCES += ./src/GeoSphereGen.cpp
...
# Forms:
FORMS += ./forms/GeoSphereSettings.ui

# Resources
RESOURCES += geospheregenerator_icon.qrc
