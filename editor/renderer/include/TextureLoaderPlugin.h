...
#ifndef TEXTURELOADERPLUGIN_H_
#define TEXTURELOADERPLUGIN_H_

#include "RendererTypes.h"

/*! \file
* 
*  \brief Describes the interface TextureLoaderPlugin, their methodes and attributes.
...
/*! \brief The interface for the texture-loader 
*
* Interface for all texture-loader. To use the loader, it must be added in the 
* TextureManager.
* 
*/
...
public:
	...
	*/	
	virtual bool execute(const string& sFileName, TextureInfo& pInfo, 
		BYTE** pData) = 0;
